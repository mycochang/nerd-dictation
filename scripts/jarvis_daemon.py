...
class JarvisDaemon:
        ...
        try:
            ...
            if ext not in ALLOWED_EXTENSIONS:
                ...
                client_socket.sendall(
                    b"ERROR: Invalid file type. Only audio files allowed."
                )
                return
            ...
            if self.model is None:
                client_socket.sendall(b"ERROR: Model is not loaded.")
                return
    ...
    def run(self):
        ...
        print(
            f"Daemon started. Will exit after {IDLE_TIMEOUT / 60} minutes of inactivity."
        )
